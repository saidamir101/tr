...
import {
  useMediaQuery, InputLabel, Select, MenuItem, FormControl, Button, TextField, Link, Snackbar, IconButton, Tooltip, LinearProgress, Box, Typography,
} from '@mui/material';
...
const LoginPage = () => {
  ...
  const filteredLanguages = languageList.filter(
    (it) => it.name === "Русский" || it.name === "English"
  );
    ...
    <LoginLayout>
      ...
      <div className={classes.container}>
        ...
        <div className={classes.extraContainer}>
          {languageEnabled && (
            <FormControl sx={{marginLeft:"185px"}} fullWidth>
